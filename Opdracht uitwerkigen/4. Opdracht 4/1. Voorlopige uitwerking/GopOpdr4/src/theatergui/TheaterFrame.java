...
public class TheaterFrame extends JFrame {
  ...
  private void mijnInit() throws TheaterException {
      ...
      if (data.size() > 0) {
        ...
        foutLabel.setText("Er zijn geen toekomstige voorstellingen");
    ...
    addWindowListener(new WindowAdapter() {
      ...
      public void windowClosing(WindowEvent arg0) {
        try {
          ...
          // een eventuele exceptie kan niet meer in de Gui getoond worden, schrijf de melding daarom naar de console.
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // een eventuele exceptie kan (nog) niet in de Gui getoond worden, schrijf de melding daarom naar de console.
      System.out.println(e.getMessage());
    }
  }
