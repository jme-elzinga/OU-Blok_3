...
public class Voorstelling {
   ...
   * 
   * @param klant de klant
   * @return true wanneer de plaats daadwerkelijk door de klant is bezet, anders false.
   * @throws TheaterException Fouten vanuit de datalaag.
   */
  public boolean plaatsKlant(Klant klant) throws TheaterException {
   ...
   * @param rijnummer  rijnummer van de plaats
   * @param stoelnummer stoelnummer van de plaats
   * @return De plaats of null wanneer de gevraagde plaats niet aanwezig is in de zaal.
   */
