...
//----------------- Eigen methoden ---------------------------------------------
  ...
  /**
   * Maakt het veld studentTextField leeg bij verandering van de ComboBox
   */
  private void opleidingComboBoxAction() {
    studentTextField.setText("");
  }

  /**
   * Maakt het veld scholerTextField leeg bij verandering van de ComboBox
   */
  private void scholingComboBoxAction() {
  ...
  private void studentButtonAction() {
    studentAdmin.voegRegulierToe(studentTextField.getText(),(String) opleidingComboBox.getSelectedItem());
    studentTextField.setText("");
  }
  ...
  private void scholerButtonAction() {
    studentAdmin.voegScholerToe(scholerTextField.getText(),(String) scholingComboBox.getSelectedItem());
    scholerTextField.setText("");
  }
  ...
  private void bestaandeNaamVeldAction() {
    studentInfoVeld.setText(studentAdmin.getStudentInfo(bestaandeNaamVeld.getText()));
  }
...
//----------------- Einde eigen methoden ---------------------------------------------
  ...
  private JComboBox getOpleidingComboBox() {
    if (opleidingComboBox == null) {
      ...
      opleidingComboBox.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent arg0) {
          opleidingComboBoxAction();
        }
      });
  ...
  private JComboBox getScholingComboBox() {
    if (scholingComboBox == null) {
      ...
      scholingComboBox.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          scholingComboBoxAction();
        }
      });
