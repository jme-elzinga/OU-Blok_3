...
//----------------- Eigen methoden ---------------------------------------------
  ...
  private void studentButtonAction() {
    String bericht = studentAdmin.voegRegulierToe(studentTextField.getText(),(String) opleidingComboBox.getSelectedItem());
    if (!bericht.contentEquals("")) {
      meldingInfoLabel(bericht);
    }
    studentTextField.setText("");
  }
  ...
  private void scholerButtonAction() {
    String bericht = studentAdmin.voegScholerToe(scholerTextField.getText(),(String) scholingComboBox.getSelectedItem());
    if (!bericht.contentEquals("")) {
      meldingInfoLabel(bericht);
    }
    scholerTextField.setText("");
  ...
  private void bestaandeNaamVeldAction() {
    ...
    String bericht = studentAdmin.getStudentInfo(naam);
    if (studentAdmin.bestaatStudent(naam)) {
      // bestaande student, toon het bericht in het studentenInfoVeld (student info)
      meldingStudentInfoVeld(bericht);
    } else {
      // onbekende student, toon het bericht in het infoLabel (foutmelding)
      meldingInfoLabel(bericht);
    }
  }
