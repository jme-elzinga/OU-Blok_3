...
abstract class Opleiding implements Cloneable {
  ...
  /**
   * Geeft het aantal punten of modules terug voor de opleiding wat benodigd is om te slagen.
   * <br>Bijzonderheden:<br> - Deze methode kan alleen aangeroepen worden binnen het package studentadmindom.<br>
   * @return Het aantal punten of modules.
   */
  abstract int getSlagingsResultaat();
